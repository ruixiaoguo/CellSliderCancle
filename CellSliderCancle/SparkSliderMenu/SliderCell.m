...
- (void)addMenusForCell{
    ...
    for (int i = 0; i < menuItems.count; i++) {
        ...
        if (item.bgImage.length!=0) {
            [btn setBackgroundImage:[UIImage imageNamed:item.bgImage] forState:UIControlStateNormal];
            btn.frame = CGRectMake(0, -5, width+3, self.frame.size.height+8);
